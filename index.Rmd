...
self-contained. `{sen2r}` is only an optional companion (a suggested package)
used to produce the Sentinel-2 raster archive that `{sen2rts}` reads; install
it separately if you need to build such an archive, referring to the
...
The [sen2rts logo](https://github.com/ranghetti/sen2rts/raw/main/man/figures/sen2rts_logo_250px.png),
