...
[![Contributor Covenant](https://img.shields.io/badge/Contributor%20Covenant-v1.4%20adopted-ff69b4.svg)](http://sen2rts.ranghetti.info/.github/CODE-OF-CONDUCT.html)
...
["The sen2rts workflows"](http://sen2rts.ranghetti.info/articles/workflow.html), which shows a simple,
...
provided by the package; refer to [this vignette](http://sen2rts.ranghetti.info/articles/workflow.html) for a wider explanation.
...
This project is released with a [Contributor Code of Conduct](http://sen2rts.ranghetti.info/.github/CODE-OF-CONDUCT.html).
